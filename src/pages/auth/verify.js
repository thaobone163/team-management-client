...
export default function Verify() {
    ...
    const formik = useFormik({
        ...
        onSubmit: handlerVerify,
    });

    async function handlerVerify(values) {
        if (!/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(values.email)) {
            ...
            await verify(values.email).then((data) => {
                if (data.success) {
                    setModalInfo(data);
        ...
        <>
            ...
            <main>
                ...
                <div className="flex px-8 pr-24 w-full">
                    <Poster></Poster>
                    <div className="w-1/3">
                        <div className="text-4xl font-semibold text-gray-700">You must verify your email!</div>
                        {/* form */}
